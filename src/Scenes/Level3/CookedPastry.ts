...
export default class CookedPastry extends Scene {
  ...
  public constructor(canvas: HTMLCanvasElement, points: number, cookCake: boolean,
    ...
    // Canvas setup
    if (this.cookCake) {
      this.canvas.style.backgroundImage = 'url(\'./assets/secondZone/cookedCake.png\')';
    } else if (this.cookCupcake) {
      this.canvas.style.backgroundImage = 'url(\'./assets/secondZone/cookedCupcake.png\')';
    } else if (this.cookCookie) {
      this.canvas.style.backgroundImage = 'url(\'./assets/secondZone/cookedCookie.png\')';
    }
  ...
  public override getNextScene(): Scene | null {
    if (this.goToSecondZone) {
      return new SecondZone(this.canvas, this.points, true, false, false, false, true);
    } else {
      return null;
    }
  }
