...
import { collisionsArrFinalZone } from '../../Collisions.js';
...
export default class FinalZone extends Scene {
  ...
  private spawnX: number = 1200;

  private spawnY: number = 40;

  private goToEndScene: boolean = false;
  ...
  public constructor(canvas: HTMLCanvasElement, points: number) {
    ...
    for (let i: number = 0; i < collisionsArrFinalZone.length; i += 70) {
      this.collisionsMap.push(collisionsArrFinalZone.slice(i, 70 + i));
    }
    ...
    this.playgroundImage.src = './assets/finalZone/finalMap.png';

    this.playgroundForeground = new Image();
    this.playgroundForeground.src = './assets/finalZone/finalMapForeground.png';
 ...
 */
  ...
  public override getNextScene(): Scene | null {
    if (this.goToEndScene) {
      return new EndScene(this.canvas);
    } else {
      return null;
    }
  }
 ...
 */
  public override render(): void {
    ...
    CanvasRenderer.writeText(this.canvas, 'GA NAAR HET DOK', 50, 102, 'left', '"Press Start 2P", sans-serif', 20, 'white');
  }
}
